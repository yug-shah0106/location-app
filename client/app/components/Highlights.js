  ...
  return (
    <View>
      <Highlight>
        ...
        <HglText>
          <Typography.Sub1>Cleanliness Enhanced</Typography.Sub1>
          <Typography.P colors={Colors.gray}>
          This host has been developed in collaboration with leading experts in public health and hospitality.
    ...
    <View>
      <Highlight>
        ...
        <HglText>
          ...
          <Typography.P colors={Colors.gray}>
          Superhosts boast a wealth of experience and high ratings, allowing guests to stay at their property.
            Hosts who do their best to make your stay comfortable.
          </Typography.P>
        </HglText>
      </Highlight>
    </View>
